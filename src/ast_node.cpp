...
pNode new_ref_node(pToken t, pNode v) { return pNode(new RefNode(t, v)); }
...
pNode new_break_node(pToken t) { return pNode(new BreakNode(t)); }

pNode new_return_node(pToken t, pNode ret) {
    return pNode(new ReturnNode(t, ret));
}

pNode new_return_node(pToken t) { return pNode(new ReturnNode(t)); }
