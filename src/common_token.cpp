...
void Token::print_message(Symbol type, int id, Symbol object, Symbol error_code)
{
    ...
    printf("%s:%d:%llu: [%s] %s %d: %s\n", p_code->file_name.c_str(), line, (unsigned long long)(token_begin - line_begin + 1), object, type, id, error_code);
